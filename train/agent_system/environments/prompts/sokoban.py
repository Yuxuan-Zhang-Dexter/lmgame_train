...
{current_observation}
Your admissible actions are ["no_op", "push up", "push down", "push left", "push right", "up", "down", "left", "right"].
...
Wall: A dark gray tile.
Floor: A white tile.
Character: A small person with blue pants. It represents you.
Box: A brown crate. It is the box you need to push.
Target: A tile with black line around it and white inside. It marks the destination where a box should be pushed.
Box on Target: A yellow crate. 
